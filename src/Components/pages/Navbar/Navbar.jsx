...
const Navber = () => {
   ...
   <li><NavLink to={"/allcontest"}> All Pet </NavLink></li>
      ...
      <div className="navbar sticky -top-2 z-20 bg-opacity-30 h-20 bg-white static:text-white  ">
        <div className="navbar-start ">
          ...
          <img
            ...
            src="https://i.ibb.co/KhNtLH5/download-removebg.png?fbclid=IwAR3XJJCr1a7JQuPF46qQIjy5Kw5kwGZ-LmKdeHAFoy6yyi-g96C-OBjM85g"
            alt=""
          />
