...
const HelpDesk = () => {
  ...
  const handelPost = async (e) => {
    ...
    const imageData=await imageUpload(fileAttachment);
    const image=imageData.data.display_url;

    const data={postContent,image};
                  ...
                  <form onSubmit={handelPost}>
                    <div className="mb-6">
                      ...
                      <textarea
                        ...
                        name="postContent"
                        rows="4"
                        className="w-full border-2 rounded-md px-4 py-2 leading-5 transition duration-150 ease-in-out sm:text-sm sm:leading-5 resize-none focus:outline-none focus:border-blue-500 bg-white"
