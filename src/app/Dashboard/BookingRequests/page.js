...
const Page = () => {
  ...
  useEffect(() => {
    ...
    const handleAccept = (allBooking, id) => {
        ...
        fetch(`https://pet-zone-project-next-js.vercel.app/bookings/accept/${id}`, {
            method: "PATCH",
            headers: {
    ...
    const handleReject = (allBooking, id) => {
        ...
        fetch(`https://pet-zone-project-next-js.vercel.app/bookings/reject/${id}`, {
            method: "PATCH",
            headers: {
                "content-type": "application/json"
            },
