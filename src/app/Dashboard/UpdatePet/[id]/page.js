    ...
    return (
      <Dashboard>
        <div className=" lg:ml-72">
          <p className="text-2xl mt-5 ml-6 font-semibold mb-2">Update Pet</p>
            ...
            <div className="flex  items-center justify-center p-12">
              <div className="mx-auto w-full max-w-[550px]">
                <h1 className="text-3xl text-center font-semibold">
                  Update <span className="text-red-500">Your</span> Desire{" "}
                  <span className="text-red-500">Pet</span> Details
                </h1>
