        ...
        <div className=" lg:ml-72">
          <div>
            <h1 className="text-5xl font-semibold mt-5 mb-10 text-center">
              Your <span className="text-red-500">Payment </span>History
            </h1>
          </div>
          ...
          <div>
            {payments.length === 0 ? (
              <>
                <p className="text-3xl w-full h-[50vh] flex justify-center items-center -mt-16  ">
                    ...
                    <tbody className="">
                      {payments.map((contest, index) => (
                        <tr key={contest._id}>
                          ...
                          <td className="text-red-500 text-lg font-semibold">
                            Pending
                          </td>
                        </tr>
                      ))}
