          ...
          >
            {isAdmin ? (
              <>
                <div className="flex flex-col items-center gap-4 border-b border-slate-200 p-6">
                  ...
                  <div className="flex min-h-[2rem] w-full min-w-0 flex-col items-start justify-center gap-0 text-center">
                    <h4 className="w-full truncate font-medium text-lg text-slate-700">
                      {user?.displayName}
                    </h4>
                    <p className="w-full  truncate text-lg text-red-400">
                     (Admin)
                    </p>
                  </div>
                </div>
                    ...
                    <ul className="flex flex-1 flex-col gap-1 py-3">
                      <li className="px-3">
                        ...
                        >
                          ...
                          <div className="flex w-full flex-1 font-medium flex-col items-start justify-center gap-0 overflow-hidden truncate text-sm">
                            {" "}
                            Profile
                          </div>
                        </Link>
                    ...
                    <ul className="flex flex-1 flex-col gap-1 py-3">
                      <li className="px-3">
                        ...
                        >
                          ...
                          <div className="flex w-full font-medium flex-1 flex-col items-start justify-center gap-0 overflow-hidden truncate text-sm">
                            Add Pet
                          </div>
                        </Link>
                      </li>
              ...
              <div className="flex flex-col items-center gap-4 border-b border-slate-200 p-6">
                  ...
                  <div className="flex min-h-[2rem] w-full min-w-0 flex-col items-start justify-center gap-0 text-center">
                    <h2 className="w-full truncate text-lg font-medium text-slate-700">
                      {user?.displayName}
                    </h2>
                    <p className="w-full truncate text-lg font-medium text-red-400">(Seller)</p>
                  </div>
                </div>
                <nav
                  aria-label="side navigation"
              ...
              <>
                <div className="flex flex-col items-center gap-4 border-b border-slate-200 p-6">
                  ...
                  <div className="flex min-h-[2rem] w-full min-w-0 flex-col items-start justify-center gap-0 text-center">
                    ...
                    <p className="w-full truncate text-lg font-medium text-red-400">(User)</p>
                  </div>
                </div>
                <nav
                  aria-label="side navigation"
