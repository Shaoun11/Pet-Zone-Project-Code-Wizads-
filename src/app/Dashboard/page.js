                  ...
                  <>
                    {
                      isSeller ?
                        ...
                        <>
                          <div className="  font-sans mb-6 pt-20 w-[200px] flex flex-row justify-center items-center">
                            <div className="card w-96 mx-auto ">
                              ...
                              <div className=" mt-2 ml-4 text-xl font-medium">
                                {user?.displayName}
                                <span className="text-red-600">(Seller)</span>
                              </div>
                            </div>
                          </div>
                          <hr className="mt-1 mb-2"></hr>
                          ...
                          <li>
                            ...
                            >
                              {" "}
                              <MdBookmarkAdded></MdBookmarkAdded> My Added Accessories
                            </Link>
                          </li>

                          <li>
                            <Link className="font-semibold focus:text-red-500 active:text-red-500" href={"/Dashboard/PaymentHistory"}><MdOutlinePayment />Payment History</Link>
                          </li>
                        ...
                        <>
                          ...
                          <li>
                            <Link className="font-semibold focus:text-red-500 active:text-red-500" href={"/Dashboard/PaymentHistory"}><MdOutlinePayment />My Payment History</Link>
                          </li>
                        </>
                    }
                  </>
