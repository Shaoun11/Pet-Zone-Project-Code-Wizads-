        ...
        <div className=" lg:ml-72">
          <div>
            <h1 className="text-5xl font-semibold mt-5 text-center">
              My Added <span className="text-red-500">Pet</span>
            </h1>
          </div>
          <div className="max-w-7xl mx-auto  mb-12  grid md:grid-cols-2 lg:grid-cols-1 grid-cols-1 gap-6"></div>
                  ...
                  <tr key={item._id}>
                    ...
                    {item.status === "accepted" ? (
                      <button className="flex gap-1 justify-center items-center font-medium text-green-600 mt-8 text-lg">
                        <MdAddTask className="text-lg"></MdAddTask> Accepted{" "}
                      </button>
                    ) : (
                      <button className="flex gap-1 justify-center items-center font-medium text-red-500 mt-8 text-lg">
                        {" "}
