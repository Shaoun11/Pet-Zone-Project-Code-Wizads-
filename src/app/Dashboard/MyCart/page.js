        ...
        <Dashboard>
            <div>
                ...
                <div className='text-right mr-20 mt-7 mb-14'>
                    {
                        data.length ?
                            <Link href="/Dashboard/Payment"><button className="btn bg-red-500 text-white text-lg">Payment</button></Link>
                            :
                            <button disabled className="btn bg-red-500 text-white">Pay</button>
                    }
                </div>
