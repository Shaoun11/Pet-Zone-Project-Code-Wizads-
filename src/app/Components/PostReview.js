...
const PostReview = () => {
    ...
    const onSubmit = (data) => {
        ...
        useAxiosPublic.post('/reviews', reviewInfo)
            .then(res => {
    ...
    return (
        <div>
            <form className="" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="inline-flex items-center gap-x-2 border border-red-500 px-6 py-4 rounded-xl hover:bg-red-500 hover:border-none hover:text-white text-red-500 font-semibold cursor-pointer">
                    Submit Review
